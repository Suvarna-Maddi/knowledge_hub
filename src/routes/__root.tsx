...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Practical IT, cloud, office and professional training in Suncity, Hyderabad." },
      { name: "author", content: "Knowledge Hub" },
      { property: "og:title", content: "Knowledge Hub Computer Training Institute" },
      { property: "og:description", content: "Practical computer training for students and professionals in Suncity, Hyderabad." },
    ...
    links: [
      ...
      { rel: "icon", href: "/knhub.png", type: "image/png" },
    ],
  }),
